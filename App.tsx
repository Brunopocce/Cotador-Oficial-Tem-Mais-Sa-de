...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    let availablePlans = (MOCK_PLANS as unknown as HealthPlan[]).filter(p => 
    ...
    <div className="min-h-screen bg-gray-50 pb-20 font-sans text-slate-800">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-40 border-b border-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 md:h-24 flex items-center justify-between">
            ...
            <div className="flex flex-col items-end cursor-pointer group select-none" onClick={() => {
               ...
               setQuoteCategory(null);
                ...
                <div className="flex items-center gap-1 -mt-2 mr-1">
                    <span className="text-[10px] font-bold text-gray-600 uppercase tracking-wider">Cotador Oficial</span>
          ...
          {/* Minimalist User Info Section */}
          <div className="flex items-center gap-4">
             <div className="flex flex-col items-end">
                <span className="text-sm font-bold text-[#003366] leading-tight">
                    {currentUser.name.split(' ')[0]}
                </span>
                <button 
                   onClick={handleLogout}
                   className="text-[10px] uppercase tracking-wider font-bold text-gray-400 hover:text-red-600 transition-colors flex items-center gap-1 mt-0.5"
                >
                   Sair
