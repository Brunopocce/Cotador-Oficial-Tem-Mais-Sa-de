...
export const PriceSummaryTable: React.FC<PriceSummaryTableProps> = ({ groups }) => {
  ...
  // Grace period tab state can handle values for both Amhemed and Fenix
            ...
            {groups.map((group, idx) => {
              ...
              return (
                <tr 
                  key={idx} 
                  onClick={() => {
                    // Reset grace period tab to default when opening modal
                    setGracePeriodTab(basePlan.operator === 'Fênix Medical' ? 'standard' : 'normal');
